          ...
          actions={
            <div className="flex shrink-0 items-center gap-2">
              ...
              >
                ...
                <span className="hidden sm:inline">{dict.clientsPage.export}</span>
                <span className="sm:hidden">{dict.clientsPage.export}</span>
              </button>
              <button
                type="button"
              ...
              >
                ...
                <span className="hidden sm:inline">{dict.clientsPage.addClient}</span>
                <span className="sm:hidden">{dict.clientsPage.addClient}</span>
              </button>
            </div>
          }
        />
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-xl border border-border bg-card p-4">
                <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                  {isEn ? "Customers with orders" : "Clients ayant commandé"}
                </p>
                <p className="mt-1 font-display text-2xl font-extrabold text-foreground">
                  {payingCustomers}
                </p>
